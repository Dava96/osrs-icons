...
export const AnimateDemo: React.FC = () => {
    ...
    const frameSources = useMemo(
        () => COIN_FRAMES.map((frame) => toDataUrl(frame)),
        [],
    );
    ...
    return (
        <section className="animate-demo">
            ...
            <p>
                ...
                <code>@keyframes</code>. No JavaScript timers —
                just <code>step-end</code> transitions that snap between sprites.
            </p>
                    ...
                    {COIN_FRAMES.map((frame, index) => (
                        <React.Fragment key={COIN_NAMES[index]}>
                            ...
                            <div className="frame-cell">
                                <div
                                    className="frame-sprite"
                                    style={{ cursor: frame }}
                                >
                                    <img
                                        src={frameSources[index]}
                                        alt={COIN_NAMES[index]}
                                    />
                                </div>
