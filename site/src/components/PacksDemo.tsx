  ...
  return (
    <section className="packs-demo">
      ...
      <p className="contribute-hint">
        ...
        <a
          href="https://github.com/Dava96/osrs-icons/blob/main/CONTRIBUTING.md"
          target="_blank"
          rel="noreferrer"
        >
          Contributing Guide
...
const PackCard: React.FC<{ pack: PackInfo }> = ({ pack }) => {
  ...
  const copyImport = () => {
    navigator.clipboard.writeText(`import { ${pack.importName} } from '@dava96/osrs-icons';`);
      ...
      <div className="progression-track">
        {pack.stages.map((cursor, i) => (
          <React.Fragment key={pack.stageLabels[i]}>
            ...
            <div className="stage-step" style={{ cursor }} title={pack.stageLabels[i]}>
