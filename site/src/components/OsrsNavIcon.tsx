...
import { spyglass, hammerIcon, present, scrapPaper, flippers, toDataUrl } from '@dava96/osrs-icons';
 ...
 */
export const OsrsNavIcon: React.FC<OsrsNavIconProps> = ({ name, size = 20, className }) => {
